...
<html>
<head>
<title>mlynn.org - Mobile Browser Device Dection Example: Normal / Full Site</title>
<meta name="description" content="Mobile Browser Device Detection and Redirection Example using PHP Iphone">
<meta name="keywords" content="iphone,ipad,mobile,detection,browser,user-agent,example,redirection,php">
...
<div id=container>
<h1>Mobile Browser Detection and Redirection Example: Normal Site</h1>
<h2>This is the Full / Normal site.  You got here because you are not using a mobile device or have specified a preference for the full site.</h2>
<p>
<?
...
echo "<p>YOUR CURRENT SITE PREFERENCE: ".$sitepref;
?>
